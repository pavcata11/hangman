...
public class Hangman {
    ...
    public static void writeHangman(char[] randomWordIS) {
        ...
        while (true) {
            ...
            char inputWord = inputWord();
            words[j] = inputWord;
            j++;
            int findCountMistake = findCountMistake(randomWordIS, inputWord, play);
